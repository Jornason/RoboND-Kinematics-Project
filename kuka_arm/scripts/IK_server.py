...
def handle_calculate_IK(req):
    ...
    if len(req.poses) < 1:
        ...
        for x in xrange(0, len(req.poses)):
            ...
            # End-effector pose with respect to the base_link(Euler angles)
        ...
        rospy.loginfo("Time taken: %s" % (time()-start_time))
